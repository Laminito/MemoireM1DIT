...
\begin{enumerate}
  ...
  \item \textbf{Suivi et amélioration continue.} L'application étant désormais accessible
  publiquement, un suivi de son usage réel et des retours des utilisateurs permettrait
  d'identifier les besoins prioritaires et de guider un réentraînement périodique du modèle à
  mesure que de nouvelles annonces sont publiées.
\end{enumerate}
