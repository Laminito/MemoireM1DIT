...
\begin{itemize}
  ...
  \item une application Streamlit interactive permet d'estimer le prix d'un bien, de comparer
  les prédictions des quatre modèles, et d'explorer visuellement le jeu de données et les
...
\begin{enumerate}
  ...
  les annonces actuelles — âge du bien, statut foncier (titre foncier), proximité d'axes ou
  d'équipements, à obtenir par géocodage des adresses — permettrait de rapprocher les
