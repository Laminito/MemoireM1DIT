...
L'application est exécutable localement (\texttt{streamlit run app.py}) et a été conçue pour
être déployable sans modification sur \emph{Streamlit Community Cloud}, à l'image du projet de
référence pris comme modèle pour ce document. Un fichier \texttt{requirements.txt} liste les
dépendances nécessaires à la reproduction de l'environnement d'exécution.
